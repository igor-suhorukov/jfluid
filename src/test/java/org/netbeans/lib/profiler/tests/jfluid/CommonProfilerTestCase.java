...
*/
    ...
    protected ProfilerEngineSettings initTest(String projectName, String mainClass, String[][] rootMethods) {
        ...
        String platformHome = System.getProperty("platform.home");//TODO return platform home
        String profilerHome = platformHome + "/profiler";
        System.setProperty("profiler.home", profilerHome);
        System.setProperty("profiler.home", profilerHome);
        System.setProperty("netbeans.dirs",platformHome + "/platform;" + profilerHome);
...
*/
/*
        commands.addAll(Arrays.asList(  "-Dcom.sun.management.jmxremote.port=5557",
...
*/
        ...
        cmdArray = new String[]{"myjvm?",//TODO implement test process
                "-J-Dcom.sun.management.jmxremote.port=5557",
        ...
        try {
            ...
            String pid = null;
            JMXConnector localhost = JMXConnectorFactory.connect(new JMXServiceURL(String.format("service:jmx:rmi:///jndi/rmi://%s:%d/jmxrmi", "localhost", 5557)));
            try {
                RuntimeMXBean platformMXBean = ManagementFactory.getPlatformMXBean(localhost.getMBeanServerConnection(), RuntimeMXBean.class);
            ...
            String options = Integer.toString(settings.getPortNo());
            String jar = settings.getJFluidRootDirName() + "/jfluid-server-15.jar"; //TODO path

            try {
                VirtualMachine virtualMachine = VirtualMachineUtils.connectToVirtualMachine(pid);
